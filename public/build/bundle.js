...
var app = (function () {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [calendarData, weekdays, getPrevMonth, getNextMonth];
    }
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ CalenderMini: Calender });
    	return [];
    }
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ TopNav: Top_nav, SideNav: Side_nav, Calender: Calender$1 });
    	return [];
    }
